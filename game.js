function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Strike Football Sports Game.loader.js";
		var config = {
        dataUrl: buildUrl + "/Strike Football Sports Game.data",
        frameworkUrl: buildUrl + "/Strike Football Sports Game.framework.js",
        codeUrl: buildUrl + "/Strike Football Sports Game.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Strike Football Sports Game",
        productVersion: "1",
      };
