function createUnityInstance(e, r, n) {
    ...
    function l(e) {
        ...
        return i.then(function(e) {
            ...
            "file:" == location.protocol ? t(n + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error") : console.error(n)
        })
    }
    function d() {
        return new Promise(function(e, r) {
            ...
            n.onload = function() {
                if ("undefined" == typeof unityFramework || !unityFramework) {
                    ...
                    t("Unable to parse " + c.frameworkUrl + "! The file is corrupt, or compression was misconfigured? (check Content-Encoding HTTP Response Header on web server)", "error")
                }
            ...
            n.onerror = function(e) {
                t("Unable to load file " + c.frameworkUrl + "! Check that the file exists on the remote server. (also check browser Console and Devtools Network tab to debug)", "error")
            }
            ,
    ...
    document.addEventListener("webkitfullscreenchange", function(r) {
        ...
        n === e ? e.style.width && (g = e.style.width,
        p = e.style.height,
        e.style.width = "100%",
    ...
    c.fetchWithProgress = function() {
        ...
        function r(r, n) {
            ...
            fetch(r, n).then(function(r) {
                function n() {
                    return "undefined" == typeof a ? r.arrayBuffer().then(function(e) {
                        return t({
                            type: "progress",
                            total: e.length,
                            loaded: 0,
